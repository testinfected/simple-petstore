...
public class SiteMeshTest {
    ...
    decoratesContentWhenRequestMatchesRegisteredDecorator() throws IOException {
        ...
        siteMesh.map("/decorated", new StaticDecorator(decoratedPage));
    ...
    @Test public void
    preservesOriginalPageEncoding() throws IOException {
        app.setContentEncoding("UTF-16");
        final String decoratedPage = "<The following characters require encoding: éçë>";
        siteMesh.map("/decorated", new StaticDecorator(decoratedPage));

        request.get("/plain/page").assertContentIsEncodedAs("UTF-16");
        request.get("/decorated/page").assertContentIsEncodedAs("UTF-16");
    }
    ...
    appliesDecoratorsInReverseOrderOfAddition() throws IOException {
        siteMesh.map("/decorated", new StaticDecorator("<generated by first decorator>"));
        siteMesh.map("/decorated/page", new StaticDecorator("<generated by last decorator>"));

        HttpResponse response = request.get("/decorated/page");
        response.assertHasContent(equalTo("<generated by last decorator>"));
    }
